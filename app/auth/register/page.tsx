...
export default function RegisterPage() {
  ...
  const createUserProfile = async (uid: string, email: string | null, name: string | null) => {
    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-gray-900 via-black to-gray-900 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-5xl font-bold text-white mb-2">SIRA AI</h1>
          <p className="text-gray-400">Multi-Agent Chat System</p>
        </div>

        <div className="bg-gray-800 rounded-lg shadow-xl p-8">
          <h2 className="text-2xl font-semibold text-white mb-6">Daftar Akun Baru</h2>
          ...
          <div className="space-y-3">
            <button
              ...
              disabled={loading}
              className="w-full bg-white hover:bg-gray-100 text-gray-900 font-semibold py-2 px-4 rounded-lg transition disabled:opacity-50 flex items-center justify-center"
            >
            ...
            <button
              ...
              disabled={loading}
              className="w-full bg-gray-700 hover:bg-gray-600 text-white font-semibold py-2 px-4 rounded-lg transition disabled:opacity-50 flex items-center justify-center"
            >
